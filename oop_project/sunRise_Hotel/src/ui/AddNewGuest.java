	...
	public AddNewGuest(ManageGuest mg) {
		...
		btnAddNewGuest.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				////////////
				String guestId = textField.getText();
		        String email = textField_2.getText();
		        
		        // Validation for guestId starting with 'GT'
		        if (!guestId.startsWith("GT")) {
		            javax.swing.JOptionPane.showMessageDialog(null, "Guest ID must start with 'GT'.");
		            return;
		        }
		        
		        // Validation for email containing '@'
		        if (!email.contains("@")) {
		            javax.swing.JOptionPane.showMessageDialog(null, "Email must contain '@'sign");
		            return;
		        }
				////////////
